...
import usePrefersReduceMotion from "@/hooks/use-prefers-reduce-motion";
    ...
    <div className="relative" ref={container}>
      ...
      {isFilled.image(slice.primary.image) && (
        <div className="hero__image glass-container mt-16 w-fit opacity-0">
          <div className="hero__glow absolute inset-0 -z-10 animate-pulse bg-indigo-600/30 opacity-0 blur-2xl filter" />
          <PrismicNextImage
